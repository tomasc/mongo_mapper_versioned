...
A versioned document automatically receives new id (versioned_id) that is shared amongst all its versions, and by default this id is used as a default key (through 'to_param' method).
